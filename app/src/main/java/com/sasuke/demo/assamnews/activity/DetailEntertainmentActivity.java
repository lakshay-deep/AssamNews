...
public class DetailEntertainmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_entertainment);
        ...
        detailLayoutManager = new LinearLayoutManager(DetailEntertainmentActivity.this, LinearLayoutManager.HORIZONTAL, false);
    ...
    private  void  initListener(){
        detailAdapter.setOnItemClickListener(new DetailAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent = new Intent(DetailEntertainmentActivity.this, DetailEntertainmentActivity.class);
                Bundle bundle = new Bundle ();
                News detail = detailList.get(position);
                bundle.putString("similar_channels", detail.getTitle());
                intent.putExtras(bundle);
                startActivity(intent);
                DetailEntertainmentActivity.this.finish();
                player.stop();
            }
        });
    }
...
//    }
    ...
    private void prepareDetailData() {
        News detail;
        detail = new News("Rang", R.drawable.rang_medium);
        detailList.add(detail);
        detail = new News("StarPlus", R.drawable.star_medium);
        detailList.add(detail);
        detail = new News("Sony", R.drawable.sony_medium);
        detailList.add(detail);
        detail = new News("SetMax", R.drawable.set_max_medium);
        detailList.add(detail);
        detail = new News("Colors", R.drawable.colors_medium);
        detailList.add(detail);
    }
